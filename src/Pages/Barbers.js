      ...
      <div className="barbers">
        ...
        <div className="barbers-container">
          <div className="barbers-container-description">
            <span>
              <span className="text-bold">Наши барберы</span> - это истинные
              мастера своего ремесла, вдохновленные страстью к созданию
              идеального образа для каждого клиента. С глубоким пониманием
              трендов и индивидуальных особенностей, они обеспечивают не только
              идеальные стрижки и бритье, но и подлинное чувство комфорта и
              доверия у каждого посетителя. Наши барберы - это не просто
              стилисты, это партнеры в вашем пути к непревзойденному облику и
              самовыражению.
            </span>
          </div>
